...
export default class Brick {
  ...
  update(time) {
    ...
    if (side) {
      ...
      if (this.speed.x <= this.game && this.speed.x >= 0) this.speed.y = -(this.game.speed - this.speed.x);
      else this.speed.y = -(this.game.speed + this.speed.x);
      if (this.speed.y < -this.game.speed) this.speed.y = -this.game.speed / 2;
    }
  }
